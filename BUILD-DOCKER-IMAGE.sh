...
# Context-sensitive behavior: If the <user> parameter "gitlab-ci" is used, 
...
DOCKER_CONTAINER="${DOCKER_PROJECT}-dev-1"
...
export DOCKERFILE_COMMIT_SHORT_SHA="$(git log -n 1 --pretty=format:%h docker/dev/Dockerfile)"
