...
*   Use prefixes to distinguish first-party resources from third-party ones. For example, add the prefix `osx_` to the names of our own packages, nodes, topics, and services where appropriate.
